...
const Index: NextPage = () => {
  ...
  return (
    <>
      <Meta title="UIAI | Digital Payment System" />
      <main>
        <Header title="Registrar" share={true} />
        <section className="content">
          <h1 className="heading">Operator UPI Payment Link Register</h1>
            ...
            <>
              ...
              <div className="generate">
                <div className="center">
                  <p className="pdetailupiid">Enter Operator VPA (UPI ID)</p>
                  <input
                    type="text"
                    placeholder="UPI ID"
                    className="inputbox"
            ...
            <>
              ...
              <div className="generate">
                <p className="paymentlinktxt">
                  Sharable link to Recieve Payment
                </p>
                <div className="center">
                  <input
                    type="text"
